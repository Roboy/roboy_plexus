...
if(MSVC)
  ...
  if(ASSIMP_BUILD_SHARED_LIBS)
    ...
    set_target_properties(assimp::assimp PROPERTIES
      ...
      IMPORTED_LOCATION_RELEASE "${ASSIMP_ROOT_DIR}/lib/arm-linux-gnueabihf/${sharedLibraryName}"
    )
    list(APPEND _IMPORT_CHECK_TARGETS assimp::assimp )
    list(APPEND _IMPORT_CHECK_FILES_FOR_assimp::assimp "${ASSIMP_ROOT_DIR}/lib/arm-linux-gnueabihf/${sharedLibraryName}" )
  else()
    set(staticLibraryName "libassimp${ASSIMP_LIBRARY_SUFFIX}.a")
    set_target_properties(assimp::assimp PROPERTIES
      IMPORTED_LOCATION_RELEASE "${ASSIMP_ROOT_DIR}/lib/arm-linux-gnueabihf/${staticLibraryName}"
    )
    list(APPEND _IMPORT_CHECK_TARGETS assimp::assimp )
    list(APPEND _IMPORT_CHECK_FILES_FOR_assimp::assimp "${ASSIMP_ROOT_DIR}/lib/arm-linux-gnueabihf/${staticLibraryName}" )
  endif()
endif()
...
set( ASSIMP_LIBRARY_DIRS "${ASSIMP_ROOT_DIR}/lib/arm-linux-gnueabihf")
