...
LEXERS = {
    ...
    'BashLexer': ('pygments.lexers.shell', 'Bash', ('scripts', 'sh', 'ksh', 'shell'), ('*.sh', '*.ksh', '*.scripts', '*.ebuild', '*.eclass', '.bashrc', 'bashrc', '.bash_*', 'bash_*', 'PKGBUILD'), ('application/x-sh', 'application/x-shellscript')),
