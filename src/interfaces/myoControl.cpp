...
void MyoControl::changeControl(int motor, int mode, control_Parameters_legacy &params, int32_t setPoint) {
...
void MyoControl::changeControl(int motor, int mode, control_Parameters_legacy &params) {
