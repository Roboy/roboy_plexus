...
#define UART_HAND_COMPONENT_TYPE Uart
#define UART_HAND_COMPONENT_NAME Uart_hand
#define UART_HAND_BASE 0x140000
#define UART_HAND_SPAN 262144
#define UART_HAND_END 0x17ffff
